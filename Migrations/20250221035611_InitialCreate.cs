    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "tion.blackmon@email.com", "Tion", "Blackmon" },
                    { 2, "bolbol_phoenixsuns-@nba.com", "Bol", "Bol" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "https://tnstateparks.com/assets/images/content-images/social-media-images/big-hill-pond.jpg", "Big Hill Pond" },
                    { 3, 1, "https://tnstateparks.com/assets/images/content-images/blog/4270/ctpp_-_peter_koczera_-_black_mountain_overlook.jpg", "Cumberland Mountain" },
                    { 4, 3, "https://nashvillefunforfamilies.com/wp-content/uploads/2016/06/Long-Hunter-State-Park.jpg", "Long Hunter" },
                    { 5, 2, "https://tnstateparks.com/assets/images/content-images/campgrounds/5030/natchez-trace_camping-cabin1.jpg", "Natchez Trace" },
                    { 6, 3, "https://i.redd.it/z7xea2cu2s451.jpg", "Frozen Head" },
                    { 7, 4, "https://tnstateparks.com/assets/images/content-images/campgrounds/279/wpsp-a5-4.jpg", "Warriors’ Path" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 7, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 2, 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 2 }
                });
